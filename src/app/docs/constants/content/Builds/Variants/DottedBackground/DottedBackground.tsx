...
export const DottedBgVaraintOverLay = () => {
    return (
        <>
            <div className="rounded-xl p-6 flex items-center justify-center max-h-[420px] h-[420px]  border border-[#333]">
                <DottedBackground dark centered boxSize={46} overlay full>

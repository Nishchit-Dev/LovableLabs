...
import { BuildPreviewCircularAnimationSection } from '../Builds/BuildPreviewCircularAnimation'

export const CircularAnimation: DocContent = {
    title: 'Square Grid Background',
    description: 'Create elegant square grid backgrounds with Lovable UI',
    preview: BuildPreviewCircularAnimationSection(),
    sections: [
        {
...
export function cn(...inputs: ClassValue[]) {
  return twMerge(clsx(inputs));
        ...
        },
        {
            ...
            codeSrc: 'components/CircularAnimation.tsx',
            code: `'use client'
